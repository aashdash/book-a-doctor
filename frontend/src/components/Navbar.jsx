...
//       <img onClick={() => navigate('/')} className='w-44 cursor-pointer px-3' src={logo} alt="" />
...
//               </div>
//             </div>
//             : <button onClick={() => navigate('/login')} className='bg-primary text-white px-8 py-3 mr-2 rounded-full font-light hidden md:block'>Create account</button>
//         }
...
//           </div>
//           <ul className='flex flex-col items-center gap-2 mt-5 px-5 text-lg font-medium gap-4'>
  ...
  return (
    <div className='flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400'>
      ...
      <div className='flex items-center gap-4 mr-3'>
        ...
        <img onClick={() => setShowMenu(true)} className='block md:hidden' src={assets.menu_icon} alt='' />
